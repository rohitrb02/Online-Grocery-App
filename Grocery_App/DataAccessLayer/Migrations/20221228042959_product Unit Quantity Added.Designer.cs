...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20221228042959_product Unit Quantity Added")]
    partial class productUnitQuantityAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryProducts", b =>
                {
                    b.HasOne("DataAccessLayer.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Products", null)
                        .WithMany()
